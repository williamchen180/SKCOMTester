...
namespace SKCOMTester
{
    public partial class SKQuote : UserControl
    {
        ...
        private void btnKLine_Click(object sender, EventArgs e)
        {
            ...
            m_nCode = m_SKQuoteLib.SKQuoteLib_RequestKLine(txtKLine.Text.Trim(), sKLineType);
        ...
        void m_SKQuoteLib_OnNotifyTicks(short sMarketNo, short sStockIdx, int nPtr, int lTimehms, int lTimemillismicros, int nBid, int nAsk, int nClose, int nQty, int nSimulate)
        {
            ...
            if (chkbox_msms.Checked == true)
                strData = nPtr.ToString() + "," + lTimehms.ToString() + "," + nBid.ToString() + "," + nAsk.ToString() + "," + nClose.ToString() + "," + nQty.ToString();
            else
                strData = nPtr.ToString() + "," + lTimehms.ToString() + lTimemillismicros.ToString() + "," + nBid.ToString() + "," + nAsk.ToString() + "," + nClose.ToString() + "," + nQty.ToString();
